...
public class GenerateCSharpCodeOfInterfaceConcept : ModelTransformationRequest, ITransformationPattern
{
    public static Guid PatternId => Guid.Parse("bdcc6109-c0a1-4f8f-bad9-240c24454447");
    ...
    public GenerateCSharpCodeOfInterfaceConcept(Guid downstreamModel, Guid upstreamModel, string downstreamNode, string relationalDimension, string contentProperty)
    {
    ...
    public GenerateCSharpCodeOfInterfaceConcept()
    {
    ...
    {
        IPatternBuilder builder = PatternBuilder.Create(GenerateCSharpCodeOfInterfaceConcept.PatternId,nameof(GenerateCSharpCodeOfInterfaceConcept),"RelationalDimension","Generate C# Code Of Interface Concepts");
...
public class GenerateCSharpCodeOfInterfaceConceptHandler : ICommandHandler<GenerateCSharpCodeOfInterfaceConcept>
{
    private IDomainModelReader _reader;
    private IDomainModelWriter _writer;
    private ITextGenerator _textGenerator;

    public GenerateCSharpCodeOfInterfaceConceptHandler(IDomainModelReader reader, IDomainModelWriter writer, ITextGenerator textGenerator)
    {
        _reader = reader;
        _writer = writer;
    ...
    public void Handle(GenerateCSharpCodeOfInterfaceConcept command)
    {
        throw new NotImplementedException();
    }

    public async Task HandleAsync(GenerateCSharpCodeOfInterfaceConcept command)
    {
        ...
        foreach(var domainObject in domainObjects)
        {
            ...
            if(targetElement == null)
                continue;
            var content = _textGenerator.InterfaceToText(targetElement);
